...
<div class="toolbar" id="filters"><input id="search" type="search" placeholder="Hisse veya ad ara (ör. ALTINS1, altın)" aria-label="Hisse veya ad ara"><span class="muted">Görünüm:</span><button class="active" data-filter="ACTIVE">AL / SAT</button><button data-filter="GÜÇLÜ AL">GÜÇLÜ AL</button><button data-filter="AL">AL</button><button data-filter="BEKLE">BEKLE</button><button data-filter="SAT">SAT</button><button data-filter="GÜÇLÜ SAT">GÜÇLÜ SAT</button></div>
